		...
		<div class="container mx-auto max-w-7xl">
			<div class="grid gap-8 md:grid-cols-4">
				...
				<div>
					...
					<ul class="space-y-2">
						<li>
							<a href={resolve('/app/courses')} class="transition-colors hover:text-white"
								>Explorar</a
							>
						</li>
						<li>
							<a href={resolve('/app/courses') + '?difficulty=BEGINNER'} class="transition-colors"
								>Principiante</a
							>
						</li>
						<li>
						...
						<li>
							<a href={resolve('/app/courses') + '?difficulty=ADVANCED'} class="transition-colors"
								>Avanzado</a
							>
						</li>
					</ul>
